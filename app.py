...
import numpy as np
import pandas as pd
import traceback  # <-- Added to expose deep trace vectors inside cloud logs
...
def predict_dataframe():
    if request.method == 'GET':
        ...
        try:
            ...
            # THIS BLOCK CAPTURES AND PRINTS THE RUNTIME CRASH DIRECTLY TO YOUR RENDER LOGS SCREEN
            print("\n!!! PIPELINE CRASH ERROR TRACEBACK !!!")
            traceback.print_exc()
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n")
            return f"Internal Server Error details captured in Render logs. Exception: {str(e)}", 500
